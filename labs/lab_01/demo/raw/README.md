...
- [NYC TLC Trip Record Data](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page) - страница публикации файлов,
  словарей и справочников.
- [Data Dictionary - Green Taxi Trip Records](https://www.nyc.gov/assets/tlc/downloads/pdf/data_dictionary_trip_records_green.pdf) -
  определения полей.
- [TLC Trip Records User Guide](https://www.nyc.gov/assets/tlc/downloads/pdf/trip_record_user_guide.pdf) - контекст
  сбора и использования данных.

## Условия использования и важное ограничение

NYC публикует наборы открытых данных без ограничений на использование. Эта папка содержит неизменённые копии файлов NYC
TLC; источник, версии, URL и контрольные суммы зафиксированы выше.
...
- Фактический диапазон `lpep_pickup_datetime`: от 2024-12-25 23:13:15 до 2025-02-05 18:46:24 (данный пункт является
  примером ограничения покрытия: обозначение файла не заменяет проверку реальных значений).
